let altura, sexo, totalHomens = 0, qtdMulheres = 0, somaAlturaMasculino = 0, maiorAltura = 0, menorAltura = Infinity;
...
if (totalMasculino > 0) {
  const mediaAlturaMasculino = somaAlturaMasculino / totalHomens;
